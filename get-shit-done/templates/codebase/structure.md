...
│   └── ez/            # EZ-specific commands
├── ez-agents/         # Skill resources
...
**New Slash Command:**
- Primary code: `commands/ez/{command-name}.md`
- Tests: `tests/commands/{command-name}.test.js` (if testing implemented)
- Documentation: Update `README.md` with new command

**New Template:**
- Implementation: `ez-agents/templates/{name}.md`
- Documentation: Template is self-documenting (includes guidelines)

**New Workflow:**
- Implementation: `ez-agents/workflows/{name}.md`
- Usage: Reference from command with `@~/.claude/ez-agents/workflows/{name}.md`

**New Reference Document:**
- Implementation: `ez-agents/references/{name}.md`
