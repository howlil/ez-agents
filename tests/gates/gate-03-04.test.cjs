...
const {
  ...
  THRESHOLDS,
} = require('../../ez-agents/bin/lib/gates/gate-03-code.cjs');
...
const {
  ...
  checkEnvVarUsage,
} = require('../../ez-agents/bin/lib/gates/gate-04-security.cjs');

// Import QualityGate for integration test
const { QualityGate } = require('../../ez-agents/bin/lib/quality-gate.cjs');
const { registerGate3 } = require('../../ez-agents/bin/lib/gates/gate-03-code.cjs');
const { registerGate4 } = require('../../ez-agents/bin/lib/gates/gate-04-security.cjs');
